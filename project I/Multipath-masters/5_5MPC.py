...
print(MPC_protocol(G, users,5000,500))
replace_node=(2,2)
...
print('\n',MPC_protocol1(a,users,replace_node,list_of_newnodes,5000,500))

print(replace_node)
'''

remove_list=[(2,2),(0,0),(0,4),(4,4),(4,0),(1,0),(0,1),(3,0),(4,1),(0,3),(1,4),(3,4),(4,3),(0,2),(2,0),(4,2),(2,4),(1,1),(3,1),(1,3),(3,3),(2,1),(2,3),(3,2),(1,2)]
result_list=[]
...
for i in remove_list:
    ...
    list_of_newnodes=R[1]
    reset_graph_state(a)
    result_list.append(MPC_protocol1(a,users,replace_node,list_of_newnodes,5000,500)[0])
    reset_graph_state(a)
print(result_list)
